...
class RNDecryptor extends RNCryptor {
	...
	private function _parseHeaders($binData) {
		...
		$this->_configureSettings(ord($versionChr),ord($optionsChr));
...
// $data = $cryptor->decrypt("ULY52ViusXbzQv9kneiGCK3JrMbf5TReUJa3Oy0fff2MItPr8jMUvZ+tgtLLBbNHdAMY7ID83Xs2SrBrWsX2Fduf/sNc2oRfgjlKierkMHEJfejL8D77oqIDi18/embB4++6/Mcn7mVH1qSuAgSOG/17/tJRC63l23AONveKJoUZG5Lk5JYkv+CjqfmPdIECX5/nFTTWic/5+hEVuLzqpF+f5xU01onP+foRFbi86qQ=", "nlDF2WVkaRFo1SKSwYmTSQXqqBtt3JO");
